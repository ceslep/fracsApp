      ...
      <div class="modal-content">
        <header class="modal-header bg-warning bg-gradient bg-opacity-75">
          <h1 class="modal-title fs-5" id="staticBackdropLabel">
            <img src="./ccfglobal.png" alt="" width="10%"><span
              class="fs-6">CcfGlobal.com</span
            >
          </h1>
          <button
            type="button"
        ...
        <main class="modal-body">
          ...
          {#if show}
            <iframe
              width="100%"
              height="100%"
              src="https://edu.gcfglobal.org/es/fraccionarios/problemas-con-multiplicacion-de-fracciones/1/"
              title="MULTIPLICACIÓN DE FRACCIONES Super fácil - Para principiantes"
              frameborder="0"
