<script>
  ...
  import "animate.css";
  import Tema4 from "../Tema4.svelte";
  import { ShowMenuFixed } from "../../../../stores";
  import MenuButtons from "../../../MenuFixed/MenuButtons.svelte";

  export let elTema = "Adición y sustracción de Fracciones";

  let cerrarTodo = false;
