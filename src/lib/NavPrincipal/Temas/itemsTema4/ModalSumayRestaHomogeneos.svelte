    ...
    <div class="modal-content">
      <header class="modal-header bg-warning bg-gradient bg-opacity-25">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">
          ...
          <span class="fs-6"> Sumar y Restar Fracciones Homogéneas </span>
        </h1>
        <button
          type="button"
          class="btn"
      ...
      <main class="modal-body">
        <SumaFracs Homogeneos={"Todos los denominadores deben ser iguales"} 
          numeradores="1,1,2,3" denominadores="5,5,5,5"
        />
      </main>
